...
Clique nas regiões para aplicar o zoom
```{r}
...
Casos  {data-icon="fa-user-plus"}
==================

Row{.tabset .tabset-fade}
----------------------------------------------------
### Acumulado Regiões-Dia
...
### Casos Por Estados
Clique na legenda para remover ou mais estados do gráfico
```{r}
