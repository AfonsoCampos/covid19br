...
### Numero de Casos Região e Estados(Clicável)
```{r}
...
### Número de Casos Brasil Acumulado
```{r}
...
### Log Número de Casos Acumulado  Por Estado     
```{r} 
...
Este site foi elaborado com intuito de fornecer gráficos sobre a evolução da pandemia do coronavírus no Brasil. As Atualizações irão ocorrer conforme os dados forem disponibilizados, sendo site atualizado de uma a duas vezes por dia.  Novas gráficos poderão ser implementados. 

**Dados** 

- Os dados para elaboração dos dados foram obtidos a partir do github do [Wesley Costa](https://github.com/wcota)

**Recomendações de Sites**

- Acredito que as melhores de informações sobre o andamento da pandemia em português estão no canal do [Atila Lamarindo]( https://www.youtube.com/channel/UCSTlOTcyUmzvhQi6F8lFi5w) no youtube. 
